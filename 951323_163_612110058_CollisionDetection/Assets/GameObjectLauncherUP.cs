...
{
    [SerializeField]protected GameObject _gameObjectToBeLaunched;
    [SerializeField]protected Transform _launchPosition;
    [SerializeField]protected float _forceMagnitude;

    [SerializeField][Tooltip("Object life time in seconds")] protected float _objectLifeTime;

    [SerializeField][Tooltip("Interval in seconds")] protected float _launchInterval = 1.0f;
